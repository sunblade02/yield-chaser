...
contract YcFactory is IYcFactory, Ownable {
    ...
    function createAccount(ERC20 _usdc, IYcStrategy _strategy, address _owner) external onlyOwner returns(IYcAccount) {
        IYcAccount account = new YcAccount(_usdc, _strategy, _owner);
